...
lcd.clear()
ssid = 'SSID' #Your Wifi SSID here
password = 'PASSWORD' #Your Wifi Password here
...
if wlan.status() != 3:
    ...
    speak('Connected!','')
while True:
    api_key = "API KEY" #Your OpenWeatherMap API key here
    location = "Province" #Your province here
